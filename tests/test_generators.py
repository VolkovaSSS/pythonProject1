    ...
    return [
        {
            ...
            "amount": "9824.07", "currency_name": "USD", "currency_code": "USD",
        ...
        },
        {
            ...
            "amount": "79114.93", "currency_name": "USD", "currency_code": "USD",
        ...
        {},
        {
            ...
            "amount": "43318.34", "currency_name": "руб.", "currency_code": "RUB",
            "description": "Перевод со счета на счет",
        ...
        },
        {
            ...
            "amount": "56883.54", "currency_name": "USD", "currency_code": "USD",
        ...
        },
        {
            ...
            "amount": "67314.70", "currency_name": "руб.", "currency_code": "RUB",
            "description": "Перевод организации",
...
def test_filter_by_currency_wrong_type():
    with pytest.raises(TypeError):
        usd_transactions = filter_by_currency({"id": 142264268}, "USD")
