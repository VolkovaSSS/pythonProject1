import pytest
from src.widget import count_number_len, mask_account_card, get_date


@pytest.mark.parametrize("test_string, expected", [("Maestro 1596837868705199", 16),
...
@pytest.mark.parametrize("test_string", [(1596837868705199),
...
@pytest.mark.parametrize("account_card_test, expected", [("Maestro 1596837868705199", "Maestro 1596 83** **** 5199"),
                                                         ("Счет 35383033474447895560","Счет **5560")])
def test_mask_account_card(account_card_test, expected):
    assert mask_account_card(account_card_test) == expected


@pytest.mark.parametrize("account_card_test", [(1596837868705),
                                               (["Maestro 1596837868705199"]),
                                               (0),
                                               ([])])
...
@pytest.mark.parametrize("account_card_test", [("Maestro 1596837868705"),
...
@pytest.mark.parametrize("test_date, expected", [("2024-03-11T02:26:18.671407", "11.03.2024"),
...
@pytest.mark.parametrize("test_date", [(20240311),
                                       (2405.00)])
...
@pytest.mark.parametrize("test_date", [("24-03-11T02:26:18.671407"),
                                       ("240311"),
